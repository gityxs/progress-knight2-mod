...
var cnItems = {
    ...
    "Font size": "字体大小",
    "for your classes and abilities equivalent to:": "你的课程和能力相当于：",
    ...
    "Small Palace": "小型宫殿",
    "Smaller": "更小",
    "Something tells you that the amulet might evolve after living for": "有些东西告诉你护身符可能会在活了",
    ...
    "ten millennia": "十千年",
    "The amulet might transform even further after living for a": "护身符可能会在活了一段时间后进一步改变",
...
var cnRegReplace = new Map([
    ...
    [/^On your 65th birthday, you once again encounter the strange, unexplained shivering from your\n(.+)amulet. But this time, a living eyeball emerges from the centre. Although terribly frightened,\n(.+)you realise you do not have many years to live left anyway so you consider touching the eye\n(.+)to see what happens.$/, '在你65岁生日时，你再次遇到奇怪的，无法解释的颤抖从你的护身符。但这一次，一个活生生的眼球从中心出现了。尽管非常害怕，你意识到你已经没有多少年可以活了，所以你考虑触摸一下眼球，看看会发生什么。'],

...
var cnRegReplace = new Map([
    ...
    [/^Battle Tactics ([\d\.,]+)\/([\d\.,]+),$/, '战斗策略 $1/$2，'],
    [/^Battle Tactics ([\d\.,]+)\/([\d\.,]+), Footman ([\d\.,]+)\/$/, '战斗策略 $1/$2，步兵 $3/'],
    [/^Battle Tactics ([\d\.,]+)\/([\d\.,]+), Centenary ([\d\.,]+)\/$/, '战斗策略 $1/$2，百夫长 $3/'],
    ...
    [/^(.+)\/(.+), Battle Tactics (.+),$/, '$1/$2，战斗策略 $3，'],
    [/^Mana Control (.+)\/(.+), Battle Tactics (.+),$/, '法力控制 $1/$2，战斗策略 $3，'],
    [/^([\d\.,]+) evil$/, '$1 邪恶'],
    [/^(.+) Dark Matter$/, '$1 暗物质'],
    [/^You have embraced evil$/, '你拥抱了邪恶'],
    [/^Embrace evil$/, '拥抱邪恶'],

...
var cnRegReplace = new Map([
    ...
    [/^Battle Tactics ([\d\.,]+)\/([\d\.,]+), Footman ([\d\.,]+)\/$/, '战斗策略 $1/$2，仆从 $3/'],
    [/^Battle Tactics ([\d\.,]+)\/([\d\.,]+), Centenary ([\d\.,]+)\/$/, '战斗策略 $1/$2，百年纪念 $3/'],
    [/^Chronomancer ([\d\.,]+)\/$/, '时空术士 $1/'],
    ...
    [/^Strength ([\d\.,]+)\/([\d\.,]+), Veteran footman ([\d\.,]+)\/$/, '力量 $1/$2，资深男仆 $3/'],
    [/^Bargaining ([\d\.,]+)\/$/, '讨价还价 $1/'],
    ...
    [/^x(.+) Essence gain \+ x(.+) Hero XP$/, 'x$1 精华增益 + x$2 英雄经验'],

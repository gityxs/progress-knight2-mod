...
var cnItems = {
    ...
    "A Dark Era": "黑暗时代",
    "A deal with the Chairman": "与主席的交易",
    ...
    "Blessed with unparalleled talent, perform unbelievable feats with magic at will. It is said that an archmage has enough destructive power to wipe an empire off the map.": "拥有无与伦比的天赋，随心所欲地施展令人难以置信的魔法壮举。 据说大法师的破坏力足以将一个帝国从地图上抹去。",
...
var cnRegReplace = new Map([
    ...
    [/^Mana Control ([\d\.,]+)\/([\d\.,]+), Meditation ([\d\.,]+)\/([\d\.,]+), Archmage ([\d\.,]+)\/$/, '法力控制 $1/$2，冥想 $3/$4，大法师 $5/'],

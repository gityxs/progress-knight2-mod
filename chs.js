...
var cnItems = {
    ...
    "The more you advance in the challenge, the higher the reward.": "您在挑战中取得的进步越多，奖励就越高。",
    ...
    "your coins, levels and max levels.": "您的硬币、等级和最高等级。",
...
var cnRegReplace = new Map([
    ...
    [/^x(.+) Longer lifespan$/, 'x$1 更长的寿命'],
    [/^x(.+) T.A.A. XP$/, 'x$1 奥术协会经验'],
    [/^x(.+) T.A.A Pay$/, 'x$1 奥术协会费用'],

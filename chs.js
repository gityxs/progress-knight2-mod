...
var cnItems = {
    ...
    "Celestial Robe": "仙袍",
    "Centenary": "百年纪念",
    "Challenge 1 Reward: Multiplies happiness by x": "挑战 1 奖励：快乐乘以 x",
    ...
    "Reduces Dark Magic and Almightiness XP effect enormously, max level reduces XP gain and happiness is reduced by ^": "极大地降低黑魔法和全能 XP 效果，最高级别减少 XP 增益，快乐减少 ^",
    "Reduces happiness by ^": "减少快乐^",
    "Reduces income by ^": "减少收入^",
    "Reduces time warping by ^": "减少时间扭曲 ^",
    "Reduces your lifespan by ^0.72, happiness does nothing and Dark Magic XP effect is always": "将你的寿命减少 ^0.72，快乐无济于事，黑魔法 XP 效果始终存在",
